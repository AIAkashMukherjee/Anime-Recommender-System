...
from src.pipeline.prediction_pipeline import hybrid_recommendation



# print(item_based_recommnedation_system('Fairy Tail', ANIME_WEIGHTS_PATH, ANIME2ANIME_ENCODED, ANIME2ANIME_DECODED, DF))
